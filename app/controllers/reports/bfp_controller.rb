module Reports
  class BfpController < ApplicationController
    def index
      ...
      @businesses = Business.created_at(from_date: @from_date, to_date: @to_date).not_transient
      respond_to do |format|
        format.html
        format.xlsx
        format.pdf do
          pdf = Reports::BfpPdf.new(@businesses, @from_date, @to_date, view_context)
