module Fees
  class OtherAccessoriesFee < ApplicationRecord
    belongs_to :business
    ...
    def self.assessment_for(business)
      ...
      business.other_accessories_fees.for_current_year - paid_amount
    end

    def debit_account
      Accounting::Asset.find_by(name: 'Accounts Receivable - Other Accessories Fees', active: true)
    end

    def credit_account
      Accounting::Revenue.find_by(name: 'Other Accessories Fees', active: true)
    end
  end
end
